...
def load_models():
    count_vectorizer = joblib.load(r"Model\count_vectorizer.pkl")
    tfidf_transformer = joblib.load(r"Model\tfidf_transformer.pkl")
    tfidf_matrix = joblib.load(r"Model\tfidf_matrix.pkl")
...
def main():
    ...
    data = load_data("Sub_Titles1.csv")
